                ...
                <br>
                            ...
                            <div class="card-body">
                                <form  action="" method="POST">
									...
									<!--<div class="input-group form-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-list" aria-hidden="true"></i></span>
                                        </div>
                                        <input type="date" class="form-control" placeholder="From date" name="fdate" required>
                                    ...
                                    <div class="input-group form-group">
                                        ...
                                        <input type="date" class="form-control" placeholder="Affected" name="tdate" required>
